...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-12 max-w-md mx-auto px-4 sm:px-6 lg:px-8">
        <form method="POST" action="<?php echo e(route('admin.category.store')); ?>" class="bg-background p-6 rounded shadow">
            <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\Wendil Rey\Desktop\Libsys\Capstone\resources\views/admin/category/create.blade.php ENDPATH**/ ?>