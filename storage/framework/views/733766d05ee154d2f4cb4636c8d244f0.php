...
<?php endif; ?>
                <?php if(Route::has('password.request')): ?>
                    <a class="text-sm text-primary hover:text-gray-900 underline focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="<?php echo e(route('password.request')); ?>">
...
<?php endif; ?>
        ...
        <div class="flex items-center justify-between mt-4">
            ...
            <div class="text-sm text-gray-600">
                ...
                <a href="<?php echo e(route('register')); ?>" class="text-primary hover:text-primary-dark underline  ms-1">
...
<?php endif; ?><?php /**PATH C:\Users\Wendil Rey\Desktop\Libsys\Capstone\resources\views/auth/login.blade.php ENDPATH**/ ?>