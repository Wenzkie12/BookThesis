<div class="flex flex-wrap gap-2 justify-center">
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit books')): ?>
        <a href="<?php echo e(route('admin.book.edit', $book)); ?>" class="w-full sm:w-20">
...
<?php endif; ?>
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete books')): ?>
        <form action="<?php echo e(route('admin.book.destroy', $book)); ?>"
              method="POST"
...
<?php endif; ?>
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('reserve books')): ?>
        <?php if($book->quantity > 0): ?>
            <form action="<?php echo e(route('reservations.store')); ?>" method="POST" class="flex flex-wrap gap-2 w-full sm:w-auto justify-center items-center">
                <?php echo csrf_field(); ?>
                <input
                    type="hidden"
                    name="book_id"
                ...
                <?php if (isset($component)) { $__componentOriginald411d1792bd6cc877d687758b753742c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald411d1792bd6cc877d687758b753742c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-button','data' => ['type' => 'submit','class' => 'w-full sm:w-24 text-sm py-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('primary-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','class' => 'w-full sm:w-24 text-sm py-2']); ?>Reserve <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald411d1792bd6cc877d687758b753742c)): ?>
<?php $attributes = $__attributesOriginald411d1792bd6cc877d687758b753742c; ?>
<?php unset($__attributesOriginald411d1792bd6cc877d687758b753742c); ?>
...
<?php /**PATH C:\Users\Wendil Rey\Desktop\Libsys\Capstone\resources\views/admin/book/actions/action.blade.php ENDPATH**/ ?>